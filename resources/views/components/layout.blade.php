                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                ...
                                <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        <li class="current dropdown"><a href="index.html">الرئيسية</a></li>
                                        <li class="dropdown"><a href="about.html">من نحن</a>
                                            <ul>
                                                <li><a href="faq.html">اسئلة شائعة</a></li>
                                                <li><a href="services.html">خدماتنا</a></li>
                                                <li><a href="gallery.html">معرض الصور</a></li>
                                            </ul>
                                        </li>
                                        <li class="dropdown has-mega-menu"><a href="#">الخدمات</a>
                                            <div class="mega-menu">
                                        ...
                                        <li class="dropdown"><a href="#">عن الدكتور</a>
                                            <ul>
                                                <li><a href="doctors.html">Doctors</a></li>
                                                <li><a href="doctors-detail.html">Doctors Detail</a></li>
                                            </ul>
                                        </li>
                                        <li style="margin-left: 20px;"><a href="blog.html">مقالات</a></li>
                    ...
                    <div class="swiper-slide slide" style="background-image:url(images/main-slider/1.jpg)">
                        <div class="auto-container">
                            <div class="content clearfix">
                                <div class="title" style="color:whitesmoke !important">مرحبًا بكم في عيادة الدكتور
                                    دياب</div>
